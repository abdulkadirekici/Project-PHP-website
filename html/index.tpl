    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="../php/index.php?nav=about">About Us</a></li>
                <li><a href="../php/index.php?nav=services">Services</a></li>
                <li><a href="../php/index.php?nav=portfolio">Portfolio</a></li>
                <li><a href="../php/index.php?nav=blog">Blog Single</a></li>
                <li><a href="../php/index.php?nav=registration">Registration</a></li>
                <li class="divider"></li>
                <li><a href="../php/index.php?nav=login">Log in</a></li>
