...
<div class="col-sm-8 col-md-8 col-lg-8 blog-main">
    ...
    <div class="blog-post">
        ...
        <p>
            ...
            <a href="index.php?pageid=1&action=toevoegen">Gebruiker toevoegen</a>
        </p>
        ...
        <form class="form-inline" action="index.php?pageid=1" method="post">
            <div class="form-group">
        ...
        <table class="table table-striped table-hover">
            ...
            <!-- START BLOCK : USERROW -->
                <tr class = "col-md-12">
                    ...
                    <td>{USERNAME}</td>
                    <td>{EMAIL}</td>
                    <td><a href="../php/index.php?pageid=1&action=wijzigen&accountid={ACCOUNTID}">Wijzigen</a> </td>
                    <td><a href="index.php?pageid=1&action=verwijderen&accountid={ACCOUNTID}">Verwijderen</a></td>
                </tr>
            <!-- END BLOCK : USERROW -->
...
<div class="col-sm-3 col-sm-offset-1 col-md-3 col-md-offset-1 col-lg-3 col-lg-offset-1 blog-sidebar">
    ...
    <div class="sidebar-module">
        <h4>Archives</h4>
        <ol class="list-unstyled textcolorsss">
