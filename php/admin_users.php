<?php
$content = new TemplatePower("../html/admin_users.tpl");
$content->prepare();
...
Email = :email");
                ...
                $content->assign("ACTION", "index.php?pageid=1&action=toevoegen");
...
AND accounts.idAccounts = :accountid");
            ...
            $content->newBlock("USERFORM");
            $content->assign("ACTION", "index.php?pageid=1&action=wijzigen");
